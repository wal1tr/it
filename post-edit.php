    ...
    <div class="container">
      <div class="columns is-centered">
        <div class="column booking-col">
          <p class="title">
            Изменить отзыв "<?php echo $customerData['postTitle']; ?>"
          </p>
          ...
          <form action="post-edit.php" method="post">
            ...
            <div class="field">
              ...
              <div class="control has-icons-left">
                <input class="input is-medium" type="text" placeholder="Ваше название" name="postTitle"
                  value="<?php echo $customerData['postTitle']; ?>" required>
            ...
            <div class="field">
              ...
              <textarea class="textarea" rows="12" placeholder="Your text.."
                name="postComment" required><?php echo $customerData['postComment']; ?></textarea>
            </div>
